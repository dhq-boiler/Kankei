...
try {
    ...
    dotnet tool run vpk -- pack --packId Kankei --packVersion $Version --packDir $publishPath --mainExe Kankei.Desktop.exe --packTitle Kankei --packAuthors dhq-boiler --icon assets/icons/kankei.ico --channel win --runtime win-x64 --delta None --outputDir $releasePath
